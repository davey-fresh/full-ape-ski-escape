...
function drawTrash(x,y){
  ...
  ctx.fillStyle='#c8c4b8';ctx.beginPath();ctx.ellipse(x-4,y+6,8,7,-0.3,0,Math.PI*2);ctx.fill();
  ctx.fillStyle='#e8e4d8';ctx.beginPath();ctx.ellipse(x+5,y+8,7,6,0.4,0,Math.PI*2);ctx.fill();
  ctx.fillStyle='#b8b4a8';ctx.beginPath();ctx.ellipse(x-2,y+14,6,5,0.1,0,Math.PI*2);ctx.fill();
  ...
  ctx.fillStyle='#f0ece0';ctx.beginPath();ctx.ellipse(x+3,y+5,4,3,0,0,Math.PI*2);ctx.fill();
}
...
function drawBeer(x,y){
  ell(x+2,y+24,12,4,'rgba(0,0,0,0.18)');
  px(x-9,y,18,24,'#c8d4e0');
  px(x-8,y+1,16,22,'#e8f0f8');
  px(x-7,y+2,14,20,'#f4f8fc');
  px(x-7,y+2,3,20,'#ffffff');
  px(x+5,y+2,3,20,'#b8c8d8');
  px(x-8,y-2,16,4,'#a8b8c8');
  px(x-7,y-3,14,3,'#d0dce8');
  px(x-5,y-4,10,2,'#e8f0f8');
  px(x-2,y-5,5,2,'#9098a8');
  px(x-1,y-6,3,2,'#a0a8b8');
  ctx.fillStyle='#1e6bb8';
  ctx.beginPath();ctx.moveTo(x-6,y+14);ctx.lineTo(x,y+4);ctx.lineTo(x+6,y+14);ctx.closePath();ctx.fill();
  ctx.fillStyle='#2a88d0';
  ctx.beginPath();ctx.moveTo(x-4,y+14);ctx.lineTo(x,y+7);ctx.lineTo(x+4,y+14);ctx.closePath();ctx.fill();
  px(x-1,y+4,3,2,'#ffffff');
  px(x-2,y+5,2,2,'#e8f4ff');
  px(x-7,y+15,14,5,'#1a5aa0');
  px(x-6,y+16,12,3,'#fff');
  px(x-5,y+20,10,2,'#1a5aa0');
  ell(x-6,y+8,1.5,2,'rgba(180,210,240,0.7)');
  ell(x+5,y+10,1.2,1.8,'rgba(180,210,240,0.65)');
  ell(x-5,y+18,1.3,1.6,'rgba(180,210,240,0.55)');
  ell(x+4,y+6,1,1.4,'rgba(200,220,255,0.5)');
}
function drawBanana(x,y){
  ctx.fillStyle='#e8c020';ctx.beginPath();ctx.ellipse(x,y+8,14,7,0.4,0,Math.PI*2);ctx.fill();
  ctx.fillStyle='#f0d040';ctx.beginPath();ctx.ellipse(x-2,y+6,10,5,0.4,0,Math.PI*2);ctx.fill();
  ctx.fillStyle='#c09010';ctx.beginPath();ctx.ellipse(x+8,y+4,4,3,-0.5,0,Math.PI*2);ctx.fill();
  px(x+10,y+2,3,3,'#3a2a10');
  ctx.fillStyle='#fff080';ctx.beginPath();ctx.ellipse(x-4,y+5,4,2,0.4,0,Math.PI*2);ctx.fill();
}
function drawRamp(x,y){
  ctx.fillStyle='#8aa8c0';ctx.beginPath();ctx.moveTo(x-28,y+18);ctx.lineTo(x+8,y-8);ctx.lineTo(x+28,y+4);ctx.lineTo(x+28,y+18);ctx.closePath();ctx.fill();
  ctx.fillStyle='#b0cce0';ctx.beginPath();ctx.moveTo(x-24,y+14);ctx.lineTo(x+6,y-4);ctx.lineTo(x+22,y+6);ctx.lineTo(x+22,y+14);ctx.closePath();ctx.fill();
